...
SYSTEM_RAG = (
    ...
    "using a header row, a separator row of hyphens (| --- | --- |), then one data row "
    "per item. Keep tables compact (few columns); put citations in cells like [1]. "
    "Do not put blank lines between table rows. "
